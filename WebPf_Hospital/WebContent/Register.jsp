...
<body>
	...
	<div id="main">
		<div id="area1">
			<h2>정보를 입력해 주세요</h2>
			<div id="form">
				<form action="RegisterToDB.jsp" name="frm" method="post"
					onsubmit="return chk()">
					<p>아이디</p>
					<input type="text" name="id" maxlength="10" required><br>
					<p
						style="font-weight: normal; color: dimgray; text-decoration: underline; margin-top: -2px">
						<a id="check" style="font-size: 12px;" onclick="idChk()">ID
							중복확인</a>
					</p>
					<p>비밀번호</p>
